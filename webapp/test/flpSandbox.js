		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Recomendation CRUD test",
									"targetURL": "#freestylecrudrecomenda-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"freestylecrudrecomenda-display": {
								"semanticObject": "freestylecrudrecomenda",
								"action": "display",
								"description": "Recomendation CRUD test",
								"title": "Recomendation CRUD test",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=freestylecrudrecomenda",
									"url": sap.ui.require.toUrl("freestylecrudrecomenda")
								}
							}
						}
					}
