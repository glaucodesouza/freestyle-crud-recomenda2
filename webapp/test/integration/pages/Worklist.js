		...
		onTheWorklistPage : {
					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success : function (oTableItem) {
							...
							this.getContext().currentItem = {
								...
								id: oBindingContext.getProperty("RecoCode"),
								name: oBindingContext.getProperty("RecoCode")
							};
						}
					}));
				},
			...
			assertions: Object.assign({
				...
				theTableShouldHaveAllEntries : function () {
					...
					// retrieve all Z270RECOMENDATIOSet to be able to check for the total amount
					this.waitFor(this.createAWaitForAnEntitySet({
						entitySet: "Z270RECOMENDATIOSet",
