sap.ui.define([
	"sap/ui/test/Opa5",
	"freestylecrudrecomenda/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("freestylecrudrecomenda.test.integration.arrangements.Startup", {
